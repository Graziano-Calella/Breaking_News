    ...
    <div class="container my-5">
        <div class="row justify-content-center align-items-center border rounded p-2 shadow">
            <div class="col-12 col-md-6">
                ...
                <p>Cosa farai: Ti occuperai di gestire le richieste di lavoro, inoltre potrai aggiugere e modificare le categorie</p>
                <h2>Lavora come revisore</h2>
                <p>Cosa farai: Ti occuperai di decidere se un articolo può essere pubblicato o meno</p>
                <h2>Lavora come redattore</h2>
                <p>Cosa farai: Ti occuperai di scrivere gli articoli di giornale</p>
            </div>
            <div class="col-12 col-md-6">
                @if ($errors->any())
